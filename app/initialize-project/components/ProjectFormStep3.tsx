...
const ProjectFormStep3: React.FC<ProjectFormStep3Props> = ({
  ...
  const timelines = [
    {
      value: "urgent",
      label: t("project.initialize.timelines.urgent", {
        default: "Urgent (ASAP)",
      }),
    },
    {
    ...
    {
      value: "flexible",
      label: t("project.initialize.timelines.flexible", {
  ...
  const budgets = [
    {
      value: "under-5k",
      label: t("project.initialize.budgets.under5k", {
        default: "Under $5,000",
      }),
    },
    {
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              <FormControl>
                <SelectTrigger className="transition-all duration-200 focus:ring-2 focus:ring-primary/20">
                  <SelectValue
                    placeholder={t("project.initialize.placeholders.timeline")}
                  />
                </SelectTrigger>
              </FormControl>
              <SelectContent>
          ...
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              <FormControl>
                <SelectTrigger className="transition-all duration-200 focus:ring-2 focus:ring-primary/20">
                  <SelectValue
                    placeholder={t("project.initialize.placeholders.budget")}
                  />
                </SelectTrigger>
              </FormControl>
              <SelectContent>
